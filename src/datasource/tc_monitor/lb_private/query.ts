/*
 * @Author: your name
 * @Date: 2021-01-14 14:28:28
 * @LastEditTime: 2021-01-17 17:26:38
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /tencentcloud-monitor-grafana-app/src/datasource/tc_monitor/lb_private/query.ts
 */
...
export class LBPrivateQueryCtrl {
  ...
  constructor($scope, $rootScope) {
    $scope.init = () => {
      $scope.LBPRIVATEFieldsDescriptor = LBPRIVATEFieldsDescriptor;
    };
...
<div class="tc-sub-params" ng-if="showDetail">
  ...
  <div class="gf-form-inline" ng-repeat="field in LBPRIVATEFieldsDescriptor">
    <div class="gf-form">
...
export function lbPrivateQuery() {
  return {
    template: template,
    controller: LBPrivateQueryCtrl,
    restrict: 'E',
    scope: {
      target: '=',
      showDetail: '=',
