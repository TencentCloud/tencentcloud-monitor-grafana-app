...
import SCF_STATE, { SCFInstanceAliasList, SCFGetInstanceQueryParams, SCFDefaultDimensionList } from './scf/query_def';
...
const SERVICES = [
  ...
  { service: 'bwp', label: '私有网络带宽包(BWP)', namespace: 'QCE/BWP', href: 'https://cloud.tencent.com/document/api/215/19209' },
  ...
  { service: 'mongoDB', label: '云数据库 MongoDB(CMONGO)', namespace: 'QCE/CMONGO', href: 'https://cloud.tencent.com/document/api/240/38568' },
  { service: 'postgres', label: '云数据库 PostgreSQL', namespace: 'QCE/POSTGRES', href: 'https://cloud.tencent.com/document/api/409/16760' },
  { service: 'lbPublic', label: '公网负载均衡(LB_PUBLIC)', namespace: 'QCE/LB_PUBLIC', href: 'https://cloud.tencent.com/document/product/248/51898' },
  { service: 'lbPrivate', label: '内网负载均衡四层协议(LB_PRIVATE)', namespace: 'QCE/LB_PRIVATE', href: 'https://cloud.tencent.com/document/product/248/51899' },
  ...
  { service: 'ckafka', label: '消息队列(CKAFKA)', namespace: 'QCE/CKAFKA', href: 'https://cloud.tencent.com/document/product/248/45143' },
