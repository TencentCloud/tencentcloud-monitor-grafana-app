...
<div ng-if="type === 'input'">
  <div ng-repeat="v in value track by $index" class="gf-form qcloud-condition-block">
    <input class="gf-form-input width-10 qcloud-condition-input" type="text" ng-model="value[$index]" placeholder="{{placeholder}}"
      ng-blur="onInputBlur()"></input>
    <label class="gf-form-label pointer qcloud-condition-minus">
      <a class="pointer" ng-click="deleteCondition($index)">
        <i class="fa fa-minus"></i>
      </a>
    </label>
  </div>
  <div class="gf-form qcloud-condition-add">
...
<div ng-if="type === 'inputNumber'">
  <div ng-repeat="v in value track by $index" class="gf-form qcloud-condition-block">
    <input type="number" ng-model="value[$index]" ng-blur="onInputBlur()" class="gf-form-input width-10 qcloud-condition-input"
...
<div class="gf-form" ng-if="type === 'select'">
  ...
  <label class="gf-form-label qcloud-info-label" ng-if="getSelectedOptions()">
    {{getSelectedOptions()}}
  </label>
</div>

<div ng-if="type === 'dropdown'">
  <div ng-repeat="v in value track by $index" class="gf-form qcloud-condition-block" style="vertical-align: top;">
    <div class="gf-form-select-wrapper gf-form-select-wrapper--caret-indent qcloud-condition-dropdown">
